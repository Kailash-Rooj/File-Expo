// BASE_URL: reads from config.js (set for production) or falls back to localhost
const BASE_URL = (window.APP_CONFIG && window.APP_CONFIG.API_URL)
...
function showDeleteModal(path, onConfirm) {
  ...
  modal.innerHTML = `
    <div class="custom-modal">
      ...
      <p>Are you sure you want to permanently delete <b>"${path}"</b>?</p>
...
function showRenameModal(oldPath, onConfirm) {
  ...
  modal.innerHTML = `
    <div class="custom-modal">
      ...
      <p>Enter a new name for <b>"${oldPath}"</b>:</p>
